...
export const content: GroupGeneralContent = {
  ...
  elements: [
    ...
    { type: "text", lang: "en", variant: "label-lg", text: "Members", x: 224, y: 301, width: 99, height: 24 },
    { type: "text", lang: "en", variant: "stat-lg", text: "24", x: 169, y: 303, width: 47, height: 48 },
    { type: "text", lang: "ko", variant: "label-lg", text: "명의 멤버", x: 224, y: 329, width: 89, height: 24 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Korean", x: 260, y: 450, width: 60, height: 20 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Chinese", x: 172, y: 610, width: 69, height: 20 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Taiwanese", x: 29, y: 945, width: 87, height: 20 },
    { type: "text", lang: "en", variant: "stat-md", text: "5", x: 199, y: 945, width: 19, height: 43 },
    { type: "text", lang: "en", variant: "label-sm", text: "Japanese", x: 226, y: 945, width: 82, height: 20 },
    { type: "text", lang: "ko", variant: "label-sm", text: "대만인", x: 29, y: 969, width: 55, height: 20 },
    { type: "text", lang: "ko", variant: "label-sm", text: "일본인", x: 226, y: 969, width: 55, height: 20 },
