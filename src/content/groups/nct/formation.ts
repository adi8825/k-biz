...
export const content: GroupGeneralContent = {
  ...
  elements: [
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Virgin Music ", x: 181, y: 622, width: 109, height: 20 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Avex Trax", x: 127, y: 704, width: 79, height: 20 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Tencent Music ", x: 130, y: 865, width: 127, height: 20 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Main Company", x: 4, y: 948, width: 130, height: 20 },
