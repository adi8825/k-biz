    ...
    <MotionConfig reducedMotion="user">
      ...
      <AnimatePresence initial={false}>
        {rows.map((row, i) => {
          ...
          /* Members rows key on the same band ids the panels use. Top 10 keeps
           * generation rows, so it never reaches this branch either. */
          const sizeId =
