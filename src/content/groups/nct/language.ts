...
export const content: GroupGeneralContent = {
  ...
  elements: [
    ...
    { type: "text", lang: "en", variant: "label-lg", text: "Songs", x: 250, y: 304, width: 66, height: 24 },
    { type: "text", lang: "en", variant: "stat-lg", text: "543", x: 171, y: 306, width: 71, height: 48 },
    { type: "text", lang: "ko", variant: "label-lg", text: "노래들", x: 250, y: 332, width: 63, height: 24 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "Korean", x: 253, y: 462, width: 60, height: 20 },
    { type: "text", lang: "ko", variant: "label-sm", text: "한국인", x: 253, y: 486, width: 52, height: 20 },
    { type: "image", src: `${ASSET}/p04.png`, x: 169, y: 536, width: 154, height: 224 },
    { type: "text", lang: "en", variant: "stat-md", text: "94", x: 186, y: 634, width: 39, height: 43 },
    { type: "text", lang: "en", variant: "label-sm", text: "Chinese", x: 171, y: 693, width: 69, height: 20 },
    { type: "image", src: `${ASSET}/p07.png`, x: 0, y: 696, width: 153, height: 144 },
    { type: "text", lang: "ko", variant: "label-sm", text: "중국인", x: 179.5, y: 721, width: 52, height: 20 },
    { type: "image", src: `${ASSET}/p06.png`, x: 169, y: 776, width: 154, height: 223.5 },
    { type: "text", lang: "en", variant: "stat-md", text: "142", x: 91, y: 792, width: 48, height: 43 },
    { type: "text", lang: "en", variant: "label-sm", text: "Japanese", x: 74, y: 851, width: 82, height: 20 },
    { type: "image", src: `${ASSET}/p08.png`, x: 0, y: 855, width: 65, height: 145 },
    { type: "text", lang: "ko", variant: "label-sm", text: "일본인", x: 89, y: 879, width: 52, height: 20 },
    ...
    { type: "text", lang: "en", variant: "label-sm", text: "English", x: 8, y: 1083, width: 61, height: 20 },
